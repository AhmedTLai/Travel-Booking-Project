        ...
        <div className="border rounded-3 py-4 px-4">
          {
            ...
            <div className="d-flex justify-content-between w-100 py-3 mb-3 gap-2 flex-wrap" style={{maxWidth : '100%'}}>
              ...
              <p className="w-100 d-flex align-items-center gap-1" style={{maxWidth : '200px', position : 'relative' }} ><i className="fa-solid flex1 fa-dollar-sign border border-dark rounded-circle w-100 text-center" style={{maxWidth : '17px' ,maxHeight : '17px', minHeight : '17px',minWidth : '17px'}}></i> {data?.price} DZD/per_person</p>
